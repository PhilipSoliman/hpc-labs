...
#SBATCH --output=/home/%u/HPC/hpc-labs/out/assignment_0a/%x.out
#SBATCH --error=/home/%u/HPC/hpc-labs/out/assignment_0a/%x.err

module load 2023r1
module load openmpi

mkdir -p ~/HPC/hpc-labs/out/assignment_0a
